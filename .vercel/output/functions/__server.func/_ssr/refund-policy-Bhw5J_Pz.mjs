...
//#region node_modules/.nitro/vite/services/ssr/assets/refund-policy-Bhw5J_Pz.js
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var _jsxFileName = "B:/flow/DEV1/Projects/E-Comerce Store/src/routes/refund-policy.tsx?tsr-split=component";
function RefundPolicy() {
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(LegalPage, {
		...
		cta: {
			label: "Shop now",
			to: "/shop",
			description: "Ready to shop with confidence?"
		}
	}, void 0, false, {
